...
$insert_product = "insert into products (date,product_title,product_img1,product_price,product_desc,product_features,status) values (NOW(),'$product_title','$product_img1','$product_price','$product_desc','$product_features','$status')";
