...
$update_product = "update products set date=NOW(),product_title='$product_title',product_img1='$product_img1',product_price='$product_price',product_desc='$product_desc',product_features='$product_features',status='$status' where product_id='$p_id'";
